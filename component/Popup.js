...
export default class FixedOutForm extends Component {
  ...
  render() {
    ...
    return (
      <Popup>
        <Form>
          <DescInput value={desc} onChangeText={this.onChangeDesc}
                     placeholder="지출내역" placeholderTextColor="#212121" />
          <PriceInput value={out} onChangeText={this.onChangeAmount}
                      placeholder="금액" placeholderTextColor="#212121"
